(function ($) {
    ...
    if ($('#newsletter-form-footer').length) {
        ...
        if (locale != 'es') {
            var title = "Successful subscription";
            var message_ok = "Thank you very much for subscribing to the newsletter.";
            var title_fail = "Failed to subscribe";
            var message_fail = "The operation could not be performed, please try again later.";
            var cerrar = "Close";
        }
        else {
            var title = "Suscripción exitosa";
            var message_ok = "Muchas gracias por suscribirse al boletín de noticias.";
            var title_fail = "Error al suscribirse";
            var message_fail = "No se pudo realizar la operación, intentelo más tarde.";
            var cerrar = "Close";
        }
        newsletter_form_footer.submit(function (e) {
            e.preventDefault();
            if (newsletter_form_footer.valid()) {
                $('.footer-widget__newsletter-btn').prop('disabled', true);
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('.footer-widget__newsletter-btn').prop('disabled', false);
                        $('input').val('');
                    },
